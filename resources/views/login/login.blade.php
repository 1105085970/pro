...
<body style="background: #fff">
	...
	<div class="container-fluid" id="login">
				...
				<div id="login_box_dbox">
					<div class="login_box_mbox">
						...
						<div class="input-group" style="margin-bottom: 10px">
							<input id="zc_name" type="text" class="form-control" placeholder="用户名" aria-describedby="basic-addon1" >
						</div>
						<div class="input-group" style="margin-bottom: 10px">
							<input id="zc_email" type="text" class="form-control" placeholder="邮箱" aria-describedby="basic-addon1" >
						</div>
						<div class="input-group" style="margin-bottom: 10px">
							<input id="zc_pass" type="text" class="form-control" placeholder="密码" aria-describedby="basic-addon1" >
						</div>
						<div class="input-group">
							<input id="zc_pass2" type="text" class="form-control" placeholder="确认密码" aria-describedby="basic-addon1" >
						</div>
						{{-- 提示 --}}
					...
					<div class="login_box_mbox">
						...
						{{-- 头像 --}}
						<img style="margin-bottom:10px;" src="/images/toux.png" class="login_box_toux rounded mx-auto d-block" >
						{{-- 用户名 --}}
						...
						<div style="color: #404040;font-size: 13px;">
							<label><input id="remember" type="checkbox" checked> 保持登录状态</label>
		...
		<div style="text-align:center;margin-top:22px;"><a href="">创建帐户</a></div>
